"""
analysis/de30_day_analysis_holdout.py

Drill-down analysis of DE30_EUR 2024-2025 holdout backtest performance by day of week.
Reads backtest/results_exit/DE30_EUR_trades.csv, filtered to entry_time >= 2024-01-01.
"""
...
TRADES_PATH = Path(__file__).parent.parent / "backtest" / "results_exit" / "DE30_EUR_trades.csv"
...
df = df[df["entry_time"] >= pd.Timestamp("2024-01-01", tz="UTC")].reset_index(drop=True)
...
print(SEP)
print("DE30_EUR 2024-2025 HOLDOUT — DAY OF WEEK DRILL-DOWN")
print(SEP)
